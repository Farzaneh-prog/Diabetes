...
class Preprocessor:
    def __init__(self, data):
        ...
        self.X = data_conv.drop(['class_Positive'], axis = 1)
        self.y = data_conv['class_Positive']
        ...
        self.count_positive = len(data_conv.loc[data_conv['class_Positive']== 1.0])
        
        #Get the absolute number of how many instances in our data belong to class one
        self.count_negative = len(data_conv.loc[data_conv['class_Positive']== 0.0])
